...
export function ReviseModal({ items, onOpenDoc, onConfirm, onCancel, note, confirmLabel }: {
  ...
  return (
    <div className="fixed inset-0 z-[60] grid place-items-center p-4" role="dialog" aria-modal="true" aria-label="Confirm revise"
      ...
      <motion.div initial={{ opacity: 0, scale: 0.97, y: 6 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 0.16, ease: [0.16, 1, 0.3, 1] }}
        ...
        <div className="flex items-start justify-between gap-3">
          <h3 className="text-[15px] font-semibold" style={{ color: 'var(--text)' }}>Confirm revise</h3>
        ...
        <p className="mt-2 text-[13px]" style={{ color: 'var(--muted)' }}>This ‘revise’ action will result in the following changes:</p>
